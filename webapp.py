    ...
    for symbol_format in symbol_formats:
        try:
            ...
            if not df.empty:
                ...
                df = df.reset_index()
                df['symbols'] = ticker  # Keep original symbol for consistency
...
st.markdown("""
    <div style="text-align: center;">
        <p class="main-header">📈 StockForecast</p>
...
<div class="highlight">
    ...
    Predict Stocks is the comprehensive financial platform designed specifically for retail investors. 
...
with col3:
    ...
    <div class="metric-box">
        ...
        <p class="metric-text"><strong>Yahoo Finance API</strong> with real-time updates</p>
    </div>
    """, unsafe_allow_html=True)
...
with st.expander("📚 Fundamental Information", expanded=True):
    ...
    with col1:
        ...
        **Complete Corporate Intelligence:**
        ...
        - **Data Export**: Download historical prices in CSV, Excel formats
...
<div style="text-align: center; color: #666; padding: 1rem;">
    <p>© 2024 Predict Stocks. All rights reserved. | Data Source: Yahoo Finance | NSE: National Stock Exchange of India</p>
</div>
""", unsafe_allow_html=True)
